...
fig.supxlabel("Time")
axs[0].plot(res_PL)
axs[0].annotate('PL',xy=(0.8,0.60), xycoords='axes fraction')
axs[1].plot(res_IE,)
axs[1].annotate('IE',xy=(0.8,0.60), xycoords='axes fraction')
axs[2].plot(res_NO)
axs[2].annotate('NO',xy=(0.8,0.60), xycoords='axes fraction')
